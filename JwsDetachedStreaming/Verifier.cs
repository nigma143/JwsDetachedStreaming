...
namespace JwsDetachedStreaming
{
    public abstract partial class Verifier
    {
        ...
        public abstract Task<bool> VerifyAsync(ReadOnlyMemory<byte> signature, CancellationToken cancellationToken = default);
    }

    public abstract partial class Verifier : Stream
    {
